...
(function () {
  ...
  /* ZIP coverage check -------------------------------------------------- */
  /* 495 ZIPs across the ten served counties (Suffolk added alongside the
     coverage-section redesign), from a public state/county/ZIP crosswalk.
     Embedded rather than fetched: it is a few KB and the answer should be
